...
local constructMainMenu = function()
    ...
    exports["vMenu"]:AddSubmenuButton("main", "bannedplayers", "Banned Players", "View and manage all banned players in this menu.")
    ...
    exports["vMenu"]:AddSubmenuButton("main", "player", "Player Related Options", "Open this submenu for player related subcategories.")
    exports["vMenu"]:AddSubmenuButton("main", "vehicle", "Vehicle Related Options", "Open this submenu for vehicle related subcategories.")
    exports["vMenu"]:AddSubmenuButton("main", "world", "World Related Options", "Open this submenu for world related subcategories.")
    ...
    exports["vMenu"]:AddSubmenuButton("main", "miscsettings", "Misc Settings", "Miscellaneous vMenu options/settings can be configured here.")
